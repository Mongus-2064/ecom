    ...
    <div>
      <section>
        <div className=' flex justify-center flex-col items-center'>
          <p className=' z-20 mt-6 md:mt-12 text-4xl md:text-6xl ubuntu-bold text-white/80 '>Resale <span className='ubuntu-bold bg-white text-black/80 px-2 rounded-md'>Your</span> Ride</p>
